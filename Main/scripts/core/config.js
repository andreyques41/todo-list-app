...
const AppUtils = {
    ...
    getCurrentTimestamp() {
        ...
        console.log(`AppUtils.getCurrentTimestamp: Generated timestamp ${timestamp}`);
        return timestamp;
    },
    ...
    getSectionForDate(dateStr) {
        console.log(`AppUtils.getSectionForDate: Determining section for date '${dateStr}'`);
...
const FormUtils = {
    ...
    getEditTaskIndex() {
        ...
        console.log(`FormUtils.getEditTaskIndex: Retrieved edit index ${idx}`);
        return idx;
    }
};
...
window.getCurrentTimestamp = AppUtils.getCurrentTimestamp;
window.compareTimestamps = AppUtils.compareTimestamps;
